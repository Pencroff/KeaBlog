...
//	},
	{
		name:'btnInlineCode',
		icon:'page_white_code_red.png',
		html:'<code>some inline code</code>',
		title:'Inline code'
	},
	{
		name:'btnBadge',
		icon:'page_white_badge.png',
		html:'<span class="badge badge-warning">some badge</span>',
		title:'Badge'
	},
	{
		name:'btnLabel',
		icon:'page_white_label.png',
		html:'<span class="label label-success">some label</span>',
		title:'Lable'
	}
];
